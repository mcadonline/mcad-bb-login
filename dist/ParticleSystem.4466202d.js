...
var ParticleSystem = function () {
  ...
  _createClass(ParticleSystem, [{
    ...
    value: function add(_ref2) {
      var positionVector = _ref2.position;
    ...
    key: "applyForcesTo",
    value: function applyForcesTo(particleFeelingForce) {
      var _this = this;
      ...
      this.particles.forEach(function (p) {
        ...
        var distSq = particleFeelingForce.getDistSqTo(p);

        // direction of accel vector, normalized (unit length is 1)
        var rVector = particleFeelingForce.getVectorTo(p).normalize();

        // accel due to gravity (magnitude)
        var gAccel = _this.gravitationalConstant / distSq;

        // limit the max acceleration
        gAccel = Math.min(gAccel, _this.maxAccel);

        // multiply our rVector by acceleration due to gravity
        // to create the gravitational acceleration vector
        var gVector = rVector.mult(gAccel);
...
//# sourceMappingURL=/ParticleSystem.4466202d.map